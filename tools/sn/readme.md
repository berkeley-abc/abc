...
2. An executable named `sn` (`sn.exe` on Windows) beside the running ABC executable.
...
Martin Povišer's [yosys-slang](https://github.com/povik/yosys-slang) has been an inspiration and a helpful guideline
for frontend semantics and lowering. The SN representation and lowering implementation are developed independently.
