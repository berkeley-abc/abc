...
ABC_DLL extern void *          Abc_FrameReadLibLutI( int i );
ABC_DLL extern void *          Abc_FrameReadLibCell();
...
ABC_DLL extern void            Abc_FrameSetLibLutI( void * pLib, int i );
ABC_DLL extern void            Abc_FrameSetLibCell( void * pLib );
